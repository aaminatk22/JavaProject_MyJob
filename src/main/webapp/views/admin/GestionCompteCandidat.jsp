        ...
        <div class="sidebar-content"> 
            ...
            <ul class="side-menu">
				...
				<li>
                    ...
                    <ul class="side-dropdown">
                        <li><a href="../GestionCandidat/GestionCompteCandidat.html">Gestion des comptes</a></li>
						<li><a href="GestionCandidature.jsp">Gestion des Candidature</a></li>
					...
					<div class="card">
						...
						<div class="card-body">
							<table class="table table-striped">
								...
								%>
								<tr>
									<td><%= candidat.getIdUtilisateur() %></td>
									<td><%= candidat.getNom() %></td>
									<td><%= candidat.getPrenom() %></td>
									<td><%= candidat.getNomUniversite() %></td>
									<td><%= candidat.getNiveauEtude() %></td>
									<td>
										<form action="CandidatServlet" method="post">
											<input type="hidden" name="action" value="edit">
											<input type="hidden" name="id" value="<%= candidat.getIdUtilisateur() %>">
											<input type="text" name="nom" value="<%= candidat.getNom() %>">
											<input type="text" name="prenom" value="<%= candidat.getPrenom() %>">
											<input type="text" name="universite" value="<%= candidat.getNomUniversite() %>">
											<input type="text" name="etablissement" value="<%= candidat.getNiveauEtude() %>">
