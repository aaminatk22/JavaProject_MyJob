        ...
        <div class="sidebar-content"> 
            ...
            <ul class="side-menu">
				...
				<li>
                    ...
                    <ul class="side-dropdown">
                        <li><a href="GestionDesProfile.jsp">Gestion des Profile</a></li>
						<li><a href="../GestionRecrutement/GestionDesAnnonce.html">Gestion des Annonces</a></li>
						...
						<div class="card-body">
							<div class="table-responsive">
								<table class="table table-striped">
									...
									<tr>
										<th scope="row"><%= annonce.getIdAnnonce() %></th>
										<td><%= annonce.getTitre() %></td>
										<td><%= annonce.getDatePublication() %></td>
										<td>
											<a href="modifierAnnonce.jsp?id=<%= annonce.getIdAnnonce() %>" class="btn btn-warning">Modifier</a>
										</td>
										<td>
											<form action="<%= request.getContextPath() %>/supprimerAnnonce" method="post" style="display:inline;">
												<input type="hidden" name="idAnnonce" value="<%= annonce.getIdAnnonce() %>">
												<button type="submit" class="btn btn-danger" onclick="return confirm('Voulez-vous vraiment supprimer cette annonce ?')">Supprimer</button>
											</form>
										</td>
									</tr>
									<% }
									...
									<tr>
										<td colspan="5" class="text-center">Aucune annonce disponible.</td>
									</tr>
									<% } %>
									</tbody>
								</table>
